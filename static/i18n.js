...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_label_agent_conn: 'Agent connection',
    settings_desc_agent_conn: 'Choose where the agent runs. Local embeds the agent in this WebUI (default). Remote bridges chat to a remote Hermes Gateway. Changes take effect immediately — no restart.',
    settings_agent_conn_local: 'Local (default)',
    settings_agent_conn_remote: 'Remote gateway',
    settings_label_agent_conn_url: 'Remote gateway address',
    settings_btn_save_agent_conn: 'Save',
    settings_agent_conn_env_warn: 'Agent connection is currently controlled by an environment variable. Changes made here will not take effect until it is unset.',
    ...
    settings_stop_gateway_confirm_title: 'Stop Hermes Agent',
    settings_stop_gateway_confirm_message: 'Stop the background Hermes Agent? Messaging platforms and scheduled jobs will stop. The WebUI is not affected.',
    settings_stop_gateway_confirm_btn: 'Stop',
    settings_stop_gateway_ok: 'Hermes Agent stopped',
    settings_stop_gateway_failed: 'Failed to stop Hermes Agent',
    // Providers panel
    ...
    workspace_browse_title: 'Choose workspace folder',
    workspace_browse_use: 'Use this folder',
    workspace_browse_up: 'Up',
    workspace_browse_roots: 'Choose a starting folder',
    workspace_browse_no_roots: 'No folders available.',
    workspace_browse_empty: 'No sub-folders here.',
    workspace_browse_not_allowed: 'This folder cannot be browsed.',
    // profile form
    ...
    messaging_tab_title: 'Messaging',
    messaging_section_title: 'Messaging platforms',
    messaging_section_meta: 'Configure chat integrations like Feishu (Lark) and WeCom (企业微信).',
    messaging_loading: 'Loading messaging platforms…',
    messaging_load_failed: (e) => `Failed to load messaging platforms: ${e}`,
    messaging_status_configured: 'Configured',
    messaging_status_not_configured: 'Not configured',
    feishu_card_name: 'Feishu (Lark)',
    feishu_card_meta: 'Connect a Feishu/Lark bot to chat with Hermes.',
    feishu_app_id: 'App ID',
    feishu_app_secret: 'App Secret',
    feishu_secret_configured: 'Configured — leave blank to keep',
    feishu_domain: 'Domain',
    feishu_domain_feishu: 'Feishu (China)',
    feishu_domain_lark: 'Lark (International)',
    feishu_connection_mode: 'Connection mode',
    feishu_mode_websocket: 'WebSocket (long connection)',
    feishu_mode_webhook: 'Webhook (HTTP callback)',
    feishu_webhook_host: 'Webhook host',
    feishu_webhook_port: 'Webhook port',
    feishu_webhook_path: 'Webhook path',
    feishu_verification_token: 'Verification token',
    feishu_encrypt_key: 'Encrypt key',
    feishu_allow_all_users: 'Allow all users to DM the bot',
    feishu_allowed_users: 'Allowed users',
    feishu_allowed_users_placeholder: 'Comma-separated open IDs',
    feishu_group_policy: 'Group policy',
    feishu_group_policy_open: 'Open — respond in groups',
    feishu_group_policy_disabled: 'Disabled — ignore groups',
    feishu_require_mention: 'Require @mention in groups',
    feishu_home_channel: 'Home channel',
    feishu_home_channel_placeholder: 'Default channel / chat ID',
    feishu_restart_after_save: 'Restart gateway after save',
    feishu_btn_validate: 'Validate',
    feishu_btn_save: 'Save',
    feishu_btn_restart: 'Restart gateway',
    feishu_validating: 'Validating credentials…',
    feishu_validate_need_app_id: 'Enter an App ID to validate.',
    feishu_validate_ok: (bot) => `Connected as ${bot}.`,
    feishu_validate_ok_generic: 'the bot',
    feishu_validate_failed: (e) => `Validation failed: ${e}`,
    feishu_validate_failed_generic: 'invalid credentials',
    feishu_saving: 'Saving…',
    feishu_saved: 'Feishu configuration saved.',
    feishu_save_failed: (e) => `Save failed: ${e}`,
    feishu_save_failed_generic: 'unknown error',
    feishu_restart_ok: (d) => d ? `Gateway restarted: ${d}` : 'Gateway restarted.',
    feishu_restart_failed: (d) => d ? `Gateway restart failed: ${d}` : 'Gateway restart failed.',
    wecom_card_name: 'WeCom (企业微信)',
    wecom_card_meta: 'Connect WeCom (WeChat Work) to chat with Hermes.',
    wecom_mode: 'Mode',
    wecom_mode_websocket: 'WebSocket smart bot (recommended)',
    wecom_mode_callback: 'Callback self-built app',
    wecom_bot_id: 'Bot ID',
    wecom_secret: 'Bot Secret',
    wecom_secret_configured: 'Configured — leave blank to keep',
    wecom_websocket_url: 'WebSocket URL',
    wecom_dm_policy: 'DM policy',
    wecom_dm_policy_open: 'Open — anyone can DM',
    wecom_dm_policy_allowlist: 'Allowlist — only allowed users',
    wecom_dm_policy_disabled: 'Disabled — no DMs',
    wecom_dm_policy_pairing: 'Pairing — bind on first contact',
    wecom_allowed_users: 'Allowed users',
    wecom_allowed_users_placeholder: 'Comma-separated user IDs',
    wecom_group_policy: 'Group policy',
    wecom_group_policy_open: 'Open — respond in groups',
    wecom_group_policy_allowlist: 'Allowlist — only allowed groups',
    wecom_group_policy_disabled: 'Disabled — ignore groups',
    wecom_home_channel: 'Home channel',
    wecom_home_channel_placeholder: 'Default chat / channel ID',
    wecom_callback_corp_id: 'Corp ID',
    wecom_callback_corp_secret: 'Corp Secret',
    wecom_callback_agent_id: 'Agent ID',
    wecom_callback_token: 'Token',
    wecom_callback_encoding_aes_key: 'Encoding AES Key',
    wecom_callback_host: 'Callback host',
    wecom_callback_port: 'Callback port',
    wecom_restart_after_save: 'Restart gateway after save',
    wecom_btn_validate: 'Validate',
    wecom_btn_save: 'Save',
    wecom_validating: 'Validating credentials…',
    wecom_validate_need_id: 'Enter the required ID to validate.',
    wecom_validate_ok: 'Credentials look valid.',
    wecom_validate_failed: (e) => `Validation failed: ${e}`,
    wecom_validate_failed_generic: 'invalid credentials',
    wecom_saving: 'Saving…',
    wecom_saved: 'WeCom configuration saved.',
    wecom_save_failed: (e) => `Save failed: ${e}`,
    wecom_save_failed_generic: 'unknown error',
    wecom_restart_ok: (d) => d ? `Gateway restarted: ${d}` : 'Gateway restarted.',
    wecom_restart_failed: (d) => d ? `Gateway restart failed: ${d}` : 'Gateway restart failed.',
    weixin_card_name: 'Weixin (个人微信)',
    weixin_card_meta: 'Connect a personal WeChat account via QR-code login (iLink Bot).',
    weixin_connected_account: (id) => `Connected — account ${id}`,
    weixin_connected_generic: 'Connected.',
    weixin_not_logged_in: 'Not logged in. Scan a QR code to connect.',
    weixin_btn_login: 'Scan to log in',
    weixin_btn_relogin: 'Re-scan to log in',
    weixin_login_starting: 'Requesting QR code…',
    weixin_login_waiting: 'Waiting for scan…',
    weixin_login_scanned: 'Scanned — confirm in WeChat…',
    weixin_login_confirmed: 'Logged in ✓',
    weixin_login_expired: 'QR code expired. Tap to try again.',
    weixin_login_failed: (e) => `Login failed: ${e}`,
    weixin_login_failed_generic: 'login failed',
    weixin_dm_policy: 'DM policy',
    weixin_dm_policy_open: 'Open — anyone can DM',
    weixin_dm_policy_pairing: 'Pairing — bind on first contact',
    weixin_dm_policy_allowlist: 'Allowlist — only allowed users',
    weixin_dm_policy_disabled: 'Disabled — no DMs',
    weixin_allowed_users: 'Allowed users',
    weixin_allowed_users_placeholder: 'Comma-separated user IDs',
    weixin_group_policy: 'Group policy',
    weixin_group_policy_disabled: 'Disabled — ignore groups',
    weixin_group_policy_open: 'Open — respond in groups',
    weixin_group_policy_allowlist: 'Allowlist — only allowed groups',
    weixin_group_allowed_users: 'Allowed groups',
    weixin_group_allowed_users_placeholder: 'Comma-separated group IDs',
    weixin_home_channel: 'Home channel',
    weixin_home_channel_placeholder: 'Default chat ID (optional)',
    weixin_restart_after_save: 'Restart gateway after save',
    weixin_btn_save: 'Save',
    weixin_saving: 'Saving…',
    weixin_saved: 'Weixin configuration saved.',
    weixin_save_failed: (e) => `Save failed: ${e}`,
    weixin_save_failed_generic: 'unknown error',
    weixin_restart_ok: (d) => d ? `Gateway restarted: ${d}` : 'Gateway restarted.',
    weixin_restart_failed: (d) => d ? `Gateway restart failed: ${d}` : 'Gateway restart failed.',
    // Unbind / logout
    weixin_btn_unbind: 'Unbind / Log out',
    weixin_unbind_confirm: 'Unbind the Weixin bot? You will need to scan the QR code again to reconnect.',
    weixin_unbinding: 'Unbinding…',
    weixin_unbound: 'Weixin unbound.',
    weixin_unbind_failed: (e) => `Unbind failed: ${e}`,
    // Pairing approval panel
    weixin_pairing_title: 'Pairing approvals',
    weixin_pairing_unavailable: 'This agent does not support pairing management. Use the CLI: hermes pairing.',
    weixin_pairing_refresh: 'Refresh',
    weixin_pairing_pending_heading: 'Pending requests',
    weixin_pairing_pending_empty: 'No pending requests.',
    weixin_pairing_approved_heading: 'Approved users',
    weixin_pairing_approved_empty: 'No approved users yet.',
    weixin_pairing_age: (m) => `${m} min ago`,
    weixin_pairing_code_placeholder: 'Paste the pairing code from the user',
    weixin_pairing_approve_btn: 'Approve',
    weixin_pairing_approve_empty: 'Enter a pairing code first.',
    weixin_pairing_approved_ok: (u) => u ? `Approved ${u}.` : 'Pairing approved.',
    weixin_pairing_approve_failed: (e) => `Approve failed: ${e}`,
    weixin_pairing_revoke_btn: 'Remove',
    weixin_pairing_revoked_ok: 'User removed.',
    weixin_pairing_revoke_failed: (e) => `Remove failed: ${e}`,
    weixin_pairing_load_failed: 'Failed to load pairing data.',
  },
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    messaging_tab_title: 'Messaging',
    messaging_section_title: 'Messaging platforms',
    messaging_section_meta: 'Configure chat integrations like Feishu (Lark).',
    messaging_loading: 'Loading messaging platforms…',
    messaging_load_failed: (e) => `Failed to load messaging platforms: ${e}`,
    messaging_status_configured: 'Configured',
    messaging_status_not_configured: 'Not configured',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    // Agent connection (local vs remote gateway)
    settings_label_agent_conn: 'Agent 连接',
    settings_desc_agent_conn: '选择 agent 在哪里运行。本地：在本 WebUI 内嵌运行 agent(默认)。远程:将聊天桥接到远程 Hermes Gateway。修改即时生效,无需重启。',
    settings_agent_conn_local: '本地(默认)',
    settings_agent_conn_remote: '远程 gateway',
    settings_label_agent_conn_url: '远程 gateway 地址',
    settings_btn_save_agent_conn: '保存',
    settings_agent_conn_env_warn: '当前 Agent 连接由环境变量控制,此处的修改在取消该环境变量前不会生效。',
    ...
    settings_stop_gateway_confirm_title: '停止 Hermes Agent',
    settings_stop_gateway_confirm_message: '停止后台 Hermes Agent?消息平台和定时任务会停止,WebUI 不受影响。',
    settings_stop_gateway_confirm_btn: '停止',
    settings_stop_gateway_ok: 'Agent 已停止',
    settings_stop_gateway_failed: '停止 Hermes Agent 失败',
    // Providers panel (English fallback — native translations welcome in follow-up PRs)
    ...
    workspace_browse: '浏览…',
    workspace_browse_title: '选择工作区目录',
    workspace_browse_use: '使用此目录',
    workspace_browse_up: '上级',
    workspace_browse_roots: '请选择起始目录',
    workspace_browse_no_roots: '没有可用的目录。',
    workspace_browse_empty: '此目录下没有子目录。',
    workspace_browse_not_allowed: '该目录无法浏览。',
    // profile form
    ...
    messaging_tab_title: '消息平台',
    messaging_section_title: '消息平台',
    messaging_section_meta: '配置聊天集成，例如飞书（Lark）和企业微信。',
    messaging_loading: '正在加载消息平台…',
    messaging_load_failed: (e) => `加载消息平台失败：${e}`,
    messaging_status_configured: '已配置',
    messaging_status_not_configured: '未配置',
    feishu_card_name: '飞书 / Lark',
    feishu_card_meta: '连接飞书 / Lark 机器人，与 Hermes 对话。',
    feishu_app_id: 'App ID',
    feishu_app_secret: 'App Secret',
    feishu_secret_configured: '已配置 — 留空则保持不变',
    feishu_domain: '域名',
    feishu_domain_feishu: '飞书（中国）',
    feishu_domain_lark: 'Lark（国际版）',
    feishu_connection_mode: '连接方式',
    feishu_mode_websocket: 'WebSocket（长连接）',
    feishu_mode_webhook: 'Webhook（HTTP 回调）',
    feishu_webhook_host: 'Webhook 主机',
    feishu_webhook_port: 'Webhook 端口',
    feishu_webhook_path: 'Webhook 路径',
    feishu_verification_token: '验证 Token',
    feishu_encrypt_key: '加密密钥',
    feishu_allow_all_users: '允许所有用户私聊机器人',
    feishu_allowed_users: '允许的用户',
    feishu_allowed_users_placeholder: '以逗号分隔的 open ID',
    feishu_group_policy: '群组策略',
    feishu_group_policy_open: '开放 — 在群组中响应',
    feishu_group_policy_disabled: '禁用 — 忽略群组',
    feishu_require_mention: '群组中需要 @机器人',
    feishu_home_channel: '默认频道',
    feishu_home_channel_placeholder: '默认频道 / 群聊 ID',
    feishu_restart_after_save: '保存后重启网关',
    feishu_btn_validate: '验证',
    feishu_btn_save: '保存',
    feishu_btn_restart: '重启网关',
    feishu_validating: '正在验证凭据…',
    feishu_validate_need_app_id: '请输入 App ID 后再验证。',
    feishu_validate_ok: (bot) => `已连接，机器人：${bot}。`,
    feishu_validate_ok_generic: '机器人',
    feishu_validate_failed: (e) => `验证失败：${e}`,
    feishu_validate_failed_generic: '凭据无效',
    feishu_saving: '正在保存…',
    feishu_saved: '飞书配置已保存。',
    feishu_save_failed: (e) => `保存失败：${e}`,
    feishu_save_failed_generic: '未知错误',
    feishu_restart_ok: (d) => d ? `网关已重启：${d}` : '网关已重启。',
    feishu_restart_failed: (d) => d ? `网关重启失败：${d}` : '网关重启失败。',
    wecom_card_name: '企业微信',
    wecom_card_meta: '连接企业微信，与 Hermes 对话。',
    wecom_mode: '模式',
    wecom_mode_websocket: 'WebSocket 智能机器人（推荐）',
    wecom_mode_callback: '回调自建应用',
    wecom_bot_id: '机器人 ID',
    wecom_secret: '机器人密钥',
    wecom_secret_configured: '已配置 — 留空则保持不变',
    wecom_websocket_url: 'WebSocket 地址',
    wecom_dm_policy: '私聊策略',
    wecom_dm_policy_open: '开放 — 任何人可私聊',
    wecom_dm_policy_allowlist: '白名单 — 仅允许的用户',
    wecom_dm_policy_disabled: '禁用 — 不响应私聊',
    wecom_dm_policy_pairing: '配对 — 首次接触时绑定',
    wecom_allowed_users: '允许的用户',
    wecom_allowed_users_placeholder: '以逗号分隔的用户 ID',
    wecom_group_policy: '群组策略',
    wecom_group_policy_open: '开放 — 在群组中响应',
    wecom_group_policy_allowlist: '白名单 — 仅允许的群组',
    wecom_group_policy_disabled: '禁用 — 忽略群组',
    wecom_home_channel: '默认频道',
    wecom_home_channel_placeholder: '默认群聊 / 频道 ID',
    wecom_callback_corp_id: '企业 ID',
    wecom_callback_corp_secret: '企业密钥',
    wecom_callback_agent_id: '应用 AgentId',
    wecom_callback_token: 'Token',
    wecom_callback_encoding_aes_key: 'EncodingAESKey',
    wecom_callback_host: '回调主机',
    wecom_callback_port: '回调端口',
    wecom_restart_after_save: '保存后重启网关',
    wecom_btn_validate: '验证',
    wecom_btn_save: '保存',
    wecom_validating: '正在验证凭据…',
    wecom_validate_need_id: '请输入必填 ID 后再验证。',
    wecom_validate_ok: '凭据校验通过。',
    wecom_validate_failed: (e) => `验证失败：${e}`,
    wecom_validate_failed_generic: '凭据无效',
    wecom_saving: '正在保存…',
    wecom_saved: '企业微信配置已保存。',
    wecom_save_failed: (e) => `保存失败：${e}`,
    wecom_save_failed_generic: '未知错误',
    wecom_restart_ok: (d) => d ? `网关已重启：${d}` : '网关已重启。',
    wecom_restart_failed: (d) => d ? `网关重启失败：${d}` : '网关重启失败。',
    weixin_card_name: '微信（个人微信）',
    weixin_card_meta: '通过扫码登录连接个人微信账号（iLink Bot）。',
    weixin_connected_account: (id) => `已连接 — 账号 ${id}`,
    weixin_connected_generic: '已连接。',
    weixin_not_logged_in: '尚未登录。扫码以连接。',
    weixin_btn_login: '扫码登录',
    weixin_btn_relogin: '重新扫码登录',
    weixin_login_starting: '正在获取二维码…',
    weixin_login_waiting: '等待扫码…',
    weixin_login_scanned: '已扫码 — 请在微信中确认…',
    weixin_login_confirmed: '已登录 ✓',
    weixin_login_expired: '二维码已过期，请重新扫码。',
    weixin_login_failed: (e) => `登录失败：${e}`,
    weixin_login_failed_generic: '登录失败',
    weixin_dm_policy: '私聊策略',
    weixin_dm_policy_open: '开放 — 任何人可私聊',
    weixin_dm_policy_pairing: '配对 — 首次联系时绑定',
    weixin_dm_policy_allowlist: '白名单 — 仅允许的用户',
    weixin_dm_policy_disabled: '禁用 — 不接收私聊',
    weixin_allowed_users: '允许的用户',
    weixin_allowed_users_placeholder: '用逗号分隔的用户 ID',
    weixin_group_policy: '群聊策略',
    weixin_group_policy_disabled: '禁用 — 忽略群聊',
    weixin_group_policy_open: '开放 — 在群聊中响应',
    weixin_group_policy_allowlist: '白名单 — 仅允许的群',
    weixin_group_allowed_users: '允许的群',
    weixin_group_allowed_users_placeholder: '用逗号分隔的群 ID',
    weixin_home_channel: '默认频道',
    weixin_home_channel_placeholder: '默认会话 ID（可选）',
    weixin_restart_after_save: '保存后重启网关',
    weixin_btn_save: '保存',
    weixin_saving: '正在保存…',
    weixin_saved: '微信配置已保存。',
    weixin_save_failed: (e) => `保存失败：${e}`,
    weixin_save_failed_generic: '未知错误',
    weixin_restart_ok: (d) => d ? `网关已重启：${d}` : '网关已重启。',
    weixin_restart_failed: (d) => d ? `网关重启失败：${d}` : '网关重启失败。',
    // 解绑 / 退出登录
    weixin_btn_unbind: '解绑 / 退出登录',
    weixin_unbind_confirm: '确定解绑微信机器人？需要重新扫码才能再次使用。',
    weixin_unbinding: '正在解绑…',
    weixin_unbound: '微信已解绑。',
    weixin_unbind_failed: (e) => `解绑失败：${e}`,
    // 配对审批面板
    weixin_pairing_title: '配对审批',
    weixin_pairing_unavailable: '当前 agent 不支持配对管理，请使用 CLI：hermes pairing。',
    weixin_pairing_refresh: '刷新',
    weixin_pairing_pending_heading: '待审批',
    weixin_pairing_pending_empty: '暂无待审批申请。',
    weixin_pairing_approved_heading: '已批准用户',
    weixin_pairing_approved_empty: '暂无已批准用户。',
    weixin_pairing_age: (m) => `${m} 分钟前`,
    weixin_pairing_code_placeholder: '粘贴用户发来的配对码',
    weixin_pairing_approve_btn: '批准',
    weixin_pairing_approve_empty: '请先输入配对码。',
    weixin_pairing_approved_ok: (u) => u ? `已批准 ${u}。` : '配对已批准。',
    weixin_pairing_approve_failed: (e) => `批准失败：${e}`,
    weixin_pairing_revoke_btn: '移除',
    weixin_pairing_revoked_ok: '已移除该用户。',
    weixin_pairing_revoke_failed: (e) => `移除失败：${e}`,
    weixin_pairing_load_failed: '加载配对数据失败。',
  },
